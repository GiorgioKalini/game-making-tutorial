...
root = Tk()
root.geometry('586x287')
root.title('Игра в кости!!! Сделай бросок!!!')
root.resizable(height=False, width=False)
root.iconphoto(True, PhotoImage(file=('iconca.png')))
font = PhotoImage(file=('holst.png'))
Label(root, image=font).pack()
lab1 = Label(root)
lab1.place(relx=0.23, rely=0.5, anchor=CENTER)
lab2 = Label(root)
lab2.place(relx=0.77, rely=0.5, anchor=CENTER)
root.bind('<1>', img)
img('event')
root.mainloop()